...
Boxy.prototype = {
    ...
    show: function() {
        ...
        this.visible = true;
		  //hide the select elements for IE6  -added by freedy
		if (document.all && !window.XMLHttpRequest) {
                        $("select").css({ visibility:"hidden" });
                        //we need to make the select elements inside the boxy pop-up visible
    ...
    hide: function(after) {
        ...
        this.boxy.stop().animate({opacity: 0}, 300, function() {
            ...
            self.visible = false;
			  //show the select elements for IE6 --added by freedy
                if (document.all && !window.XMLHttpRequest) {
